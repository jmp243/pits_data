...
PITS_susp <- read_csv("~/data librarian/PITS_Data/PITS_ListSuspensions2023_Sept11_2025.csv")
PITS_susp <- PITS_susp %>% 
  select(-`Person Name`)
...
MyPC_2024 <- read_csv("~/data librarian/MyPC_data/MyPC_2024_siteAndLocationUsage.csv", 
                      skip = 15)
MyPC_2025 <- read_csv("~/data librarian/MyPC_data/MyPC_Sept9_2025_siteAndLocationUsage.csv", 
                      skip = 15)
