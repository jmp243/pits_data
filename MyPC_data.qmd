...
table_html <- summary_table2 %>%
  kable("html", 
        col.names = c(
          ...
          "Avg Daily Users", "Avg Daily Infractions", "Infractions per 1000 Users"
        )) %>%
   add_header_above(c("PITS Incidents per 1000 PC Users (Jan 2024 - Mar 2025)" = 6)) %>%  # Add table title spanning all 4 columns
  kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = FALSE
  ) %>%
