  ...
  body = dashboardBody(
    ...
    fluidRow(
      box(
        ...
        width = 4,
        height = "100%", 
        p("Unique public PC users per hour group"),
      ...
      box(
        ...
        width = 8,
        height = "100%", 
        p("The ratio summary data represents number of infractions per 1000 public computer users."),
